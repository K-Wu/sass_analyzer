...
app_pretty_names = {"rgcn": "RGCN", "rgat": "RGAT", "hgt": "HGT"}
...
kern_blacklist = {"redzone", "CUDA memset", "CUDA memcpy"}
...
def get_configs() -> Tuple[list[str], list[str], str, str]:
    ...
    return (
        config_rgcn_list,
        config_rgat_hgt_list,
        config_rgcn_default,
        config_rgat_hgt_default,
    )


app_configs: dict[str, set[str]] = {
    "RGCN": set(get_configs()[0]),
    "RGAT": set(get_configs()[1]),
    "HGT": set(get_configs()[1]),
}
app_default_conig: dict[str, str] = {
    "RGCN": get_configs()[2],
    "RGAT": get_configs()[3],
    "HGT": get_configs()[3],
}
